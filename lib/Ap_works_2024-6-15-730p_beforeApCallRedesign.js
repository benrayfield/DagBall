...
//
//Requires Gob.js?? (nevermind that, switching to Axgob.js?? in dagball, unknown if will hook in here)
...
//2024-5-15 theres
Ap.Ape.prototype.toMem = function(lang, optional_isSecondPass){ //FIXME rename Ape.toMem to toCall since it returns an Ap.Call not an Ap.Mem (Call contains 3 Mems).
