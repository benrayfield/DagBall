...
//combinators as primaryKeys. Its for massively multiplayer turing-complete-customizable game rules
...
const AG = (()=>{
	...
	let Axgob = AG.Axgob = function(sim, i, l, r){
		...
		//so if you want to sync use the 256 bit lazyEvaled global id which will be something like
		...
		this.i = i|0; //int32
		this.l = l; //left/func/l Axgob
		this.r = r; //right/param/r Axgob
	...
	Sim.prototype.ilr = function(i,l,r){
		...
		return this.slowDedupp[slowKey] || (this.slowDedup[slowKey] = new Axgob(this,i,l,r));
	};
