...
//
throw 'TODO shouldIUseWikibinator203LicenseForFutureVersionsOfAxgobVsKeepMIT? before i tie the quine knot again.';
const AG = (()=>{
	const AG = {};
	...
	let Op = AG.Op = function(name,cur,description,func,funcI){
	...
	let Axgob = AG.Axgob = function(sim, i, j, l, r){
